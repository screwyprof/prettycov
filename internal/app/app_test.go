...
func TestRunAppliesEveryExcludePattern(t *testing.T) {
	...
	assert.Contains(t, stderr.String(), `-exclude "cmd/" left out 10 statements in 1 files`)
	assert.Contains(t, stderr.String(), `-exclude "testutil" left out 10 statements in 1 files`)
